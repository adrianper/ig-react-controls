import{j as t,a}from"./jsx-runtime-29545a09.js";import{u as o}from"./index-a1cf9e47.js";import"./index-76fb7be0.js";import"./_commonjsHelpers-de833af9.js";function r(n){const e=Object.assign({h3:"h3",pre:"pre",code:"code"},o(),n.components);return a("div",{children:[t(e.h3,{id:"styles-file-generalscss",children:"Styles file general.scss"}),t(e.pre,{children:t(e.code,{className:"language-css",children:`@import url('https://fonts.googleapis.com/css2?family=Montserrat:wght@100;200;300;400;500;600;700;800;900&display=swap');
...
body {
    ...
    --color--blue--8: #95D3CA;
    --color--blue--9: #EBF4F3;
    --color--blue--10: #008DDD;
    --color--red--1: #FF0000;
    --color--red--2: #ff4444;
    --color--yellow--1: #FFD600;
    --color--magenta--1: #CC176A;
    --color--purple--1: #5d0bc9;
    --color--purple--2: #730afc;
    --color--purple--3: #D8BFF8;
    ...
    /*-----------------------------THEME-------------------------------*/
    // Components' main colors
    --component--color: var(--color--purple--1);
    --component--color--active: var(--color--purple--2);
    --component--option--bg-color--hover: var(--color--purple--3);
...
.react_icon.react_icon--hover_colored {
...
.animation--pulse {
    ...
    // animation-timing-function: cubic-bezier(0.42, 0, 0.07, 1.02);
...
`})})]})}function g(n={}){const{wrapper:e}=Object.assign({},o(),n.components);return e?t(e,Object.assign({},n,{children:t(r,n)})):r(n)}export{g as default};
